...
Modified Jan 26, 2015 Peter de Gosztonyi*/

var s_account="";

if (env_scode_adds == null){
	var env_scode_adds = "";
}


if ((env_scode == "prd") && (env_scode_adds == "olcs-search"))
{
	s_account="alcatel-lucent-com,alcatel-lucent-com-os";
}
else if (env_scode == "prd")
{
	s_account="alcatel-lucent-com";
}


else if ((env_scode == "stg") && (env_scode_adds == "olcs-search"))
{
	s_account="alcatel-lucent-com-stg,alcatel-lucent-com-os-stg";
}

else if (env_scode == "stg")
{
	s_account="alcatel-lucent-com-stg";
}


else if ((env_scode == "qa") && (env_scode_adds == "olcs-search"))
{
	s_account="alcatel-lucent-com-qa,alcatel-lucent-com-os-qa";
}

else if (env_scode == "qa")
{
	s_account="alcatel-lucent-com-qa";
}


else if ((env_scode == "dev") && (env_scode_adds == "olcs-search"))
{
	s_account="alcatel-lucent-com-dev,alcatel-lucent-com-os-dev";
}
else if (env_scode == "dev")
{
	s_account="alcatel-lucent-com-dev";
}

else if (env_scode == "blog-prd")
{
	s_account="alcatel-lucent-com,alcatel-lucent-com-blog";
}
else if (env_scode == "blog-stg")
{
	s_account="alcatel-lucent-com-stg";
}
else if (env_scode == "test")
{
	s_account="alcatel-lucent-com-drupal-dev";
}

else if (env_scode == "support-portal-prd")
{
	s_account="alcatel-lucent-support-portal-prd";
}

else if (env_scode == "support-portal-stg")
{
	s_account="alcatel-lucent-support-portal-stg";
}
...
s.linkDownloadFileTypes="avi,crl,crt,doc,docx,eps,exe,gz,mov,mp3,mpeg,mpg,pdf,pps,ppt,pptx,rtf,tif,vsd,wav,wmv,xls,xlsx,zip"
s.linkInternalFilters="javascript:,alcatel-lucent.com,lucent.com,alcatel.com,alcatel-lucent,www.alcatel-lucent.,alcatel-lucent.,www1.alcatel-lucent.,www2.alcatel-lucent.,webform.alcatel-lucent.com,enterprise.alcatel-lucent.com,lte.alcatel-lucent.com,www-lte.alcatel-lucent.com,www3.alcatel-lucent.,www.alu.staging.zanka.,"
...
s.formList="viewPC_7_0_C6R_:How_to_Buy_jsp1:_id2,viewPC_7_0_BBT_:DocDownloadRegister:register"
s.trackFormList=true
s.trackPageName=false
s.useCommerce=true
s.varUsed="eVar6"
s.eventList="scOpen" //Abandon,Success,Error

function s_doPlugins(s) {
    /* External Campaign Tracking */
    s.campaign=s.getQueryParam('s_cid,SP_MID');
    s.campaign=s.getValOnce(s.campaign,"s_cid",0);
    s.eVar14=s.getQueryParam("SP_RID");

    /* Internal Campaign Tracking */
    s.eVar1=s.getQueryParam("s_icid");
    s.eVar1=s.getValOnce(s.eVar1,"s_icid",0);

    /* Form Analysis */
    // set s.formList before uncommenting
    s.setupFormAnalysis();
}
...
s.Integrate.onLoad=function(s,m){
   ...
   */
	...
	_db._key="eaafea09bb916a89134fa017f06857bb";
	...
	_db._dimensionArrayCustom=[
		{"id":"account_status","max_size":30},
		{"id":"ip","max_size":30},
		{"id":"marekting_alias","max_size":30},
		{"id":"city","max_size":30},
		{"id":"phone","max_size":30},
		{"id":"country_name","max_size":30},
		{"id":"varies","max_size":30},
...
s.visitorNamespace="lucent"
s.trackingServer="lucent.122.2o7.net"
